  ...
  const handleCreateVault = async () => {
    try {
      ...
      toast({
        ...
        description:
          "Your secure vault has been created. Now add assets and beneficiaries!",
        status: "success",
        duration: 4000,
        isClosable: true,
      });
          ...
          <>
                      ...
                      <Flex gap={5} align="start">
                        ...
                        <Box>
                          ...
                          <Text color="blue.700" maxW="xl">
                            Your vault is where you store digital assets and
                            designate who should receive them. It's like a
                            digital safety deposit box with automatic
                            inheritance.
                          </Text>
                        </Box>
                      </Flex>
                    ...
                    >
                      <Flex gap={5} align="start">
                        <Box
                          ...
                          borderRadius="xl"
                          boxShadow="sm"
                          color={dmsInfo?.isOverdue ? "red.500" : "green.500"}
                        >
                        ...
                        <Box>
                          <HStack mb={2}>
                            <Heading
                              size="md"
                              color={
                                dmsInfo?.isOverdue ? "red.800" : "green.800"
                              }
                            >
                              {dmsInfo?.isOverdue
                                ? "Check In Overdue!"
                          ...
                          <Text
                            color={dmsInfo?.isOverdue ? "red.700" : "green.700"}
                            maxW="xl"
                          >
                            {dmsInfo?.isOverdue
            ...
            >
              <StatCard
                ...
                icon={FaClock}
                colorScheme={
                  dmsInfo?.daysRemaining < 3
                    ? "red"
                    : dmsInfo?.daysRemaining < 7
                      ? "orange"
                      : "brand"
                }
              />
                      ...
                      <Flex justify="space-between" align="center" mb={6}>
                        <Box>
                          ...
                          <Text color="gray.500" fontSize="sm" mt={1}>
                            Assets stored here will be transferred to your
                            beneficiaries
                          </Text>
                        </Box>
                      </Flex>
